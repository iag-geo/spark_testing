...
conda env config vars set PYSPARK_DRIVER_PYTHON="${HOME}/opt/miniconda3/envs/geospark3_env/bin/python"
...
echo "y" | conda install -c conda-forge pyspark=${SPARK_VERSION} psycopg2 jupyter
